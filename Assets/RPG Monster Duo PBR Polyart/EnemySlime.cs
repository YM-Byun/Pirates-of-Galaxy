...
namespace Unity.FPS.AI
{
    ...
    public class EnemySlime : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<EnemyController, EnemySlime>(m_EnemyController, this,
                gameObject);
            ...
            DebugUtility.HandleErrorIfNullGetComponent<AudioSource, EnemySlime>(m_AudioSource, this, gameObject);
