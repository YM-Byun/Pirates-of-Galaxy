...
namespace Unity.FPS.AI
{
    ...
    public class EnemyBear : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<EnemyController, EnemyBear>(m_EnemyController, this,
                gameObject);
            ...
            DebugUtility.HandleErrorIfNullGetComponent<AudioSource, EnemyBear>(m_AudioSource, this, gameObject);
